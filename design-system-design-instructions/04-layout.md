...
- **Desktop Command shell:** sidebar at the **inline-start** (right side in RTL), 240 px wide, `--surface-page` Command ink with hairline at its inline-end; content area beside it.
