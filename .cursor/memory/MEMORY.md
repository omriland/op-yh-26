...
- **Partner Telegram bot (2026-08-30 revise):** MCP-style connect — bot sends short `/oauth/authorize?client_id&state`; profile **חיבורים** is revoke-only (no **חבר לטלגרם**). Fill API unchanged (`responder:fill`, 60-day token). Spec: `2026-08-30-yahpaz-telegram-mcp-style-connect-design.md`; contract `/partner-api/` v1.1.
